 ...
 *  你不是一个人在战斗
 */
class TopBarLayout(context: Context?, attrs: AttributeSet?) : ConstraintLayout(context, attrs) {
    ...
    init {
        ...
        //自定义属性
        if (context != null) {
            val typedArray: TypedArray = context.obtainStyledAttributes(attrs, R.styleable.TopBar)
